...
/**
 * This class extends abstract main.java.CTR.Cipher class. It implements AES in counter mode.
 */
public class AesCtr extends JavaxCipher
{
    ...
    /**
     * Class constructor. Creates a Javax.Crypto.main.java.CTR.Cipher instance with AES in CTR<br>
    ...
    {
        //use default constructor for cipher.main.java.CTR.Cipher
        super();
     ...
     * 					 May throw exception based on Javax.Crypto.main.java.CTR.Cipher class
     */
